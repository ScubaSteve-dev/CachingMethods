...
public class FourWayAssociativeCache implements Comparator<AssociateNode> {
	final static int ASSLEVEL = 4;
	int CacheBlocks;
	...
	FourWayAssociativeCache(int input){
		CacheBlocks = input;
