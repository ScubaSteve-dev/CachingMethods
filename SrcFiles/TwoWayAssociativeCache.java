...
public class TwoWayAssociativeCache implements Comparator<AssociateNode> {
	final static int ASSLEVEL = 2;
	int CacheBlocks;
	...
	TwoWayAssociativeCache(int input){
		CacheBlocks = input;
